        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    logged_on_utc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    created_on_utc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_login_histories_user_id_logged_on_utc",
                table: "login_histories",
                columns: new[] { "user_id", "logged_on_utc" });
