...
public sealed class EmailChannel : INotificationChannel
{
    ...
    public EmailChannel(IConfiguration cfg)
    {
        _smtpServer = cfg.GetValue<string>($"{NotificationCfg.EmailSettings.Section}:{NotificationCfg.EmailSettings.SmtpServer}")!;
        _smtpPort = cfg.GetValue<int>($"{NotificationCfg.EmailSettings.Section}:{NotificationCfg.EmailSettings.SmtpPort}", 587);
        _fromAddress = cfg.GetValue<string>($"{NotificationCfg.EmailSettings.Section}:{NotificationCfg.EmailSettings.FromAddress}", "admin@progcoder.com")!;
        _fromName = cfg.GetValue<string>($"{NotificationCfg.EmailSettings.Section}:{NotificationCfg.EmailSettings.FromName}", "ProG Coder")!;
        ...
        _enableSsl = cfg.GetValue<bool>($"{NotificationCfg.EmailSettings.Section}:{NotificationCfg.EmailSettings.EnableSsl}", false);
        _timeoutMs = cfg.GetValue<int>($"{NotificationCfg.EmailSettings.Section}:{NotificationCfg.EmailSettings.TimeoutMs}", 30000);
    }
