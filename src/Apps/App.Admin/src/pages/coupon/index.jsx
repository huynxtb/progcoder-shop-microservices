...
const CouponPage = () => {
  ...
  const confirmDelete = () => {
    console.log("Deleting coupon:", itemToDelete?.id);
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                >
                  {viewingCoupon.status === "active" && t("coupon.active")}
                  {viewingCoupon.status === "inactive" && t("coupon.inactive")}
                  {viewingCoupon.status === "expired" && t("coupon.expired")}
                </span>
              </div>
            </div>
